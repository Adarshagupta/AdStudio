...
export function StudioFloatingToolbar({
  ...
  return (
    ...
    >
      <div className="studio-toolbar overflow-hidden rounded-2xl border border-zinc-200/90 bg-white/95 shadow-[0_12px_40px_rgba(15,23,42,0.12)] backdrop-blur-md dark:border-zinc-700 dark:bg-zinc-900/95">
        <div className="flex items-end gap-2 border-b border-zinc-100 px-3 py-2.5 dark:border-zinc-800">
          <Textarea
            ...
            className="min-h-[40px] flex-1 resize-none border-0 bg-transparent px-0 py-1.5 text-sm leading-5 text-zinc-800 shadow-none placeholder:text-zinc-400 focus-visible:ring-0 dark:text-zinc-100"
          />
          <Button
            type="button"
            size="icon"
            ...
            className="h-9 w-9 shrink-0 rounded-full bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900"
...
function FlowsToolButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex h-9 w-9 items-center justify-center rounded-xl text-zinc-500 transition hover:bg-zinc-100 hover:text-zinc-900 disabled:opacity-40 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100",
