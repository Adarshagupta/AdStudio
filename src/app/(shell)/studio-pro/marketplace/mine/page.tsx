      ...
      <div className="space-y-8 py-4 md:py-8">
        <section className="space-y-4">
          <Link
            ...
            className="inline-flex items-center gap-1 text-sm text-zinc-500 transition hover:text-foreground"
          >
          ...
          <div className="space-y-2">
            ...
            <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground">My templates</h1>
        ...
        {listings.length === 0 ? (
          <section className="rounded-3xl bg-zinc-100/70 px-8 py-16 text-center">
            <h2 className="font-display text-2xl font-semibold text-foreground">No listings yet</h2>
          ...
          <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {listings.map((listing) => (
              <Link
                ...
                className="rounded-2xl border border-border bg-card p-4 transition hover:border-purple-200 hover:shadow-md"
              >
